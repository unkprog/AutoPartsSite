...
begin
  ...
  select @Uid, [DeliveryRouteID] = 0, [DeliveryTariffID] = 0, [DeliveryAddressID] = 0, [BillingAddressID] = 0, [Comment] = N''
       , [OrderCurrencyID] = 0, [OrderCurrencyRate] = 0, [CartCurrencyID] = 0, [CartCurrencyRate] = 0
       , [InvoiceCurrencyID] = 0, [InvoiceCurrencyRate] = 0, [AccountingCurrencyID] = 0, [PromoCode] = @PromoCode
